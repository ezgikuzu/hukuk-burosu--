...
export default function OverviewTab() {
  ...
  // Filter lists based on the active lawyer
  ...
  // Upcoming hearings for active lawyer
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Main Grid: Upcoming Hearings + Finances & Quick Actions */}
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        {/* Left Column: Hearings (7 cols) */}
        ...
        {/* Right Column: Financial Overview & Cari List (5 cols) */}
